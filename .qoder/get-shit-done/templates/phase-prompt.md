...
<!-- For checkpoint task examples and patterns, see @.qoder/get-shit-done/references/checkpoints.md -->
...
See `.qoder/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `.qoder/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `.qoder/get-shit-done/workflows/verify-phase.md` for verification logic.
