...
RUNTIME_DIRS=( "claude:.qoder" "opencode:.config/opencode" "opencode:.opencode" "gemini:.gemini" "codex:.codex" )
...
global: `.qoder/`, `~/.config/opencode/`, `~/.opencode/`, `~/.gemini/`, or `~/.codex/`
local: `./.qoder/`, `./.config/opencode/`, `./.opencode/`, `./.gemini/`, or `./.codex/`)
...
for dir in .qoder .config/opencode .opencode .gemini .codex; do
