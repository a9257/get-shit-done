...
See .qoder/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using .qoder/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using .qoder/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from .qoder/get-shit-done/templates/discovery.md
...
Use .qoder/get-shit-done/templates/discovery.md.
